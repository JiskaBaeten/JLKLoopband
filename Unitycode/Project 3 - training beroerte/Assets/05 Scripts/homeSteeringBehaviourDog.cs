...
public class homeSteeringBehaviourDog : MonoBehaviour
{
  ...
  string cameraTopObjectTag = "cameraTopObject";
  ...
  RaycastHit hitinfo;
  string collisionAvoidancePointTag = "collisionAvoidancePoint";
  ...
  void Start()
  {
    ...
    dogMouthBone = GameObject.FindWithTag(dogMouthTag);
    ...
    ballToFetch = GameObject.FindWithTag(ballTag);
    carpet = GameObject.FindWithTag(carpetTag);
    avoidancePointsWithFetch = new List<Vector3>();
    avoidancePointsGameObjects = GameObject.FindGameObjectsWithTag(collisionAvoidancePointTag);
